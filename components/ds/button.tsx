...
export const primaryBtn =
  "group inline-flex items-center gap-1.5 rounded-md border border-numo-blue-500 bg-numo-warm-blue-700 px-5 py-2 text-sm font-medium text-white transition-all duration-200 ease-out hover:border-numo-blue-400 hover:bg-numo-warm-blue-600 hover:shadow-[0_0_0_1px_hsl(var(--numo-blue-400)/0.35),0_8px_18px_hsl(var(--numo-blue-500)/0.28)] active:opacity-95";
